...
const features = [
  {
    ...
    description: "MailMate reads full conversations and returns a clean 3-bullet summary with urgent, action, or FYI priority classification.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Action Generation",
    description: "Every analyzed thread can generate a reply draft, a calendar event, and extracted tasks from the same context window.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Inbox Search And Review",
    description: "Users can browse a threaded inbox, search by sender, subject, or content, and inspect the full conversation before acting.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Human Approval Layer",
    description: "Nothing is blindly executed. Drafts and extracted actions stay editable so the user can approve, discard, or regenerate them.",
    visual: "security",
  },
];
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-10 lg:mb-14">
          ...
          >
            Built for email triage.
            <br />
            <span className="text-muted-foreground">Focused on decisions, not inbox clutter.</span>
          </h2>
        </div>
