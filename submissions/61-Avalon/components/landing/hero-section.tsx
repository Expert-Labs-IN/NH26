...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-20 lg:py-24">
        {/* Eyebrow */}
        <div 
        ...
        <div className="flex gap-16 marquee whitespace-nowrap">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-16">
              {[
                { value: "6", label: "sample inbox threads", company: "DEMO DATA" },
                { value: "18", label: "emails across realistic conversations", company: "THREAD COVERAGE" },
                { value: "3", label: "AI summaries returned per analysis", company: "ACTION CONTEXT" },
                { value: "3", label: "approval-ready action types", company: "REPLY CALENDAR TASK" },
              ].map((stat) => (
