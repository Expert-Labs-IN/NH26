...
const integrations = [
  { name: "Gmail", category: "Inbox Source" },
  ...
  { name: "NextAuth", category: "Google Session Flow" },
  { name: "Supabase", category: "Planned Persistence" },
];
...
export function IntegrationsSection() {
  ...
  return (
    <section id="integrations" ref={sectionRef} className="relative py-14 lg:py-20 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        {/* Header */}
        <div
          className={`text-center max-w-3xl mx-auto mb-10 lg:mb-14 transition-all duration-700 ${
