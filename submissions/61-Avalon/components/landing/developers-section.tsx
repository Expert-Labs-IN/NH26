...
const codeExamples = [
  {
    label: "Analyze",
    code: `const analysis = await fetch('/api/analyze', {
  method: 'POST',
...
const result = await analysis.json()`,
  },
  {
    label: "Actions",
    code: `const actions = {
  reply: await generateReply(thread),
  event: await extractCalendarEvent(thread),
  tasks: await extractTasks(thread)
}`,
  },
  {
    label: "Auth",
  ...
  GoogleProvider({
    authorization: {
      params: {
        scope: 'openid email profile gmail.readonly gmail.send calendar'
      }
    }
  })
]`,
...
const features = [
  ...
  { 
    title: "Groq-powered", 
    description: "AI summaries, reply drafting, and extraction flows are driven by Groq models."
  },
  { 
    title: "Typed UI flow", 
...
export function DevelopersSection() {
  ...
  return (
    <section id="developers" ref={sectionRef} className="relative py-14 lg:py-20 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-6 text-sm">
              <a href="#features" className="text-foreground hover:underline underline-offset-4">
                Product coverage
              </a>
