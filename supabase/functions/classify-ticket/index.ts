        ...
        tools: [{
          ...
          function: {
            ...
            parameters: {
              type: "object",
              properties: {
                category: { type: "string", enum: ["valid", "spam", "duplicate"] },
                priority: { type: "string", enum: ["low", "medium", "high", "critical"] },
                sentiment: { type: "string" },
                department: { type: "string", enum: ["IT", "Finance", "HR", "Operations", "Marketing", "General"] },
                root_cause: { type: "string" },
                suggested_reply: { type: "string" },
              },
              required: ["category", "priority", "sentiment", "department", "root_cause", "suggested_reply"],
